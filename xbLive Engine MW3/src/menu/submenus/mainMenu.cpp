...
namespace MainMenuVars {
	...
	void NoRecoil() {
		Native::Write1Byte(GetPatch(xbLive.pPatches->MW3.NoRecoil), vars.bNoRecoil ? 0x0 : 0x7);
	}

	void NoSway() {
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW3.NoSway[0]), vars.bNoSway ? 0x60000000 : 0x4BFFEA61);
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW3.NoSway[1]), vars.bNoSway ? 0x60000000 : 0x4BFFFB9D);
	}

	void NoFlinch() {
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW3.NoFlinch), vars.bNoFlinch ? 0x4e800020 : 0x7D8802A6);
	}

	void NoScreenEffects() {
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW3.NoScreenEffects[0]), vars.bNoScreenEffects ? 0x4e800020 : 0x3D400010);
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW3.NoScreenEffects[1]), vars.bNoScreenEffects ? 0x4e800020 : 0x7D8802A6);
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW3.NoScreenEffects[2]), vars.bNoScreenEffects ? 0x4e800020 : 0x7D8802A6);
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW3.NoScreenEffects[3]), vars.bNoScreenEffects ? 0x4e800020 : 0x3D400000);
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW3.NoScreenEffects[4]), vars.bNoScreenEffects ? 0x4e800020 : 0x3D600007);
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW3.NoScreenEffects[5]), vars.bNoScreenEffects ? 0x4e800020 : 0x7D8802A6);
	}

	void ConstantRadar() {
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW3.ConstantRadar), vars.bConstantRadar ? 0x3B800001 : 0x557C87FE);
	}

	void Laser() {
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW3.Laser),vars.bLaser ? 0x38600001 : 0x38600000);
	}
