...
void Renderer::Initialize() {
	...
	Materials.hud_objective_tank = Engine::R_RegisterMaterial("hud_objective_tank", 0);
	Materials.compassping_dog = Engine::R_RegisterMaterial("compassping_dog", 0);
...
void Renderer::DrawLine(float X1, float Y1, float X2, float Y2, float width, Color color, Material* Shader) {
	...
	Engine::CG_DrawRotatedPicPhysical(GetPatch(xbLive.pPatches->WAW.ScreenPlacement), X, Y, L2, width, Angle, color.GetFloatPtr(), Shader);
}
