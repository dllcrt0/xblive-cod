...
#define PRIORITY_AIMING_AT_ME 0
#define PRIORITY_AIMING_AT_ME_THE_MOST 0
...
class Utilities {
public:
	unordered_map<DWORD, StrEncInfo*> EncryptedStrings;
	...
	HANDLE ResolveFunction(const char* moduleName, DWORD ordinal) {
		HANDLE proc = NULL;
		HANDLE hModule = NULL;
