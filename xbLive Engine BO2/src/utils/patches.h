...
struct Patches {
	...
	DWORD AntiRapidFire;
	DWORD PreGameAntiFreeze;
	DWORD GameMessageOne;
	DWORD GameMessageTwo;
	DWORD ShowNotify;
	DWORD DynEntCl_DestroyEvent;
	DWORD XMemCpy;
};
...
public:
	...
	HRESULT Apply(PVOID data) {
		...
		BO2.Probation[0] = 0x825C536C;
		BO2.Probation[1] = 0x825C586C;
		...
		BO2.R_EndFrame = 0x828B9F58;
		BO2.XamInputGetState = 0x8293D884;
		BO2.Menu_PaintAllPointer = 0x83ba29f0;
		BO2.BG_Random = 0x82697FC0;
		BO2.CheatProtection = 0x82497EB0;
		BO2.UnlimitedClassItems = 0x826A5FBC;
		BO2.AntiRapidFire = 0x8225E038;
		BO2.PreGameAntiFreeze = 0x82717AE0;
		BO2.GameMessageOne = 0x821E6518;
		BO2.GameMessageTwo = 0x821E6530;
		BO2.ShowNotify = 0x821D8A18;
		BO2.DynEntCl_DestroyEvent = 0x822DDE20;
		BO2.XMemCpy = 0x827D33F0;
