...
namespace ESPMenuVars {
	...
	void PatchGameNames() {
		*(DWORD*)GetPatch(xbLive.pPatches->MW1.PatchGameNames[0]) = (vars.bDrawNames || vars.bDrawDistance) ? 0x60000000 : 0x4BFFF971;
		*(DWORD*)GetPatch(xbLive.pPatches->MW1.PatchGameNames[1]) = (vars.bDrawNames || vars.bDrawDistance) ? 0x60000000 : 0x4BFFF6C9;
	}
