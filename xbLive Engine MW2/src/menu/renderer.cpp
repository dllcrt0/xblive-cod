...
void Renderer::Initialize() {
	...
	Materials.compassping_friendly_mp = Engine::R_RegisterMaterial("compassping_friendly_mp", 0);
...
void Renderer::DrawLine(float X1, float Y1, float X2, float Y2, float width, Color color, Material* Shader) {
	...
	Engine::CG_DrawRotatedPicPhysical(GetPatch(xbLive.pPatches->MW2.ScreenPlacement), X, Y, L2, width, Angle, color.GetFloatPtr(), Shader);
}
