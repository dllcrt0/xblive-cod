...
namespace ESPMenuVars {
	...
	void PatchGameNames() {
		*(DWORD*)GetPatch(xbLive.pPatches->MW2.PatchGameNames[0]) = (vars.bDrawNames || vars.bDrawDistance) ? 0x60000000 : 0x4BFFF1A1;
		*(DWORD*)GetPatch(xbLive.pPatches->MW2.PatchGameNames[1]) = (vars.bDrawNames || vars.bDrawDistance) ? 0x60000000 : 0x4BFFF3C9;
	}
