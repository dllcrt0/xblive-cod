...
namespace MainMenuVars {
	...
	void NoRecoil() {
		Native::Write1Byte(GetPatch(xbLive.pPatches->MW2.NoRecoil), vars.bNoRecoil ? 0x0 : 0x7);
	}

	void NoSway() {
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW2.NoSway[0]), vars.bNoSway ? 0x60000000 : 0x4BFFEAA9);
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW2.NoSway[1]), vars.bNoSway ? 0x60000000 : 0x4BFFFBC5);
	}

	void NoFlinch() {
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW2.NoFlinch), vars.bNoFlinch ? 0x60000000 : 0x4BFFF945);
	}

	void NoScreenEffects() {
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW2.NoScreenEffects[0]), vars.bNoScreenEffects ? 0x4e800020 : 0x3D40000F);
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW2.NoScreenEffects[1]), vars.bNoScreenEffects ? 0x4e800020 : 0x7D8802A6);
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW2.NoScreenEffects[2]), vars.bNoScreenEffects ? 0x4e800020 : 0x7D8802A6);
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW2.NoScreenEffects[3]), vars.bNoScreenEffects ? 0x4e800020 : 0x3D608268);
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW2.NoScreenEffects[4]), vars.bNoScreenEffects ? 0x4e800020 : 0x3D600007);
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW2.NoScreenEffects[5]), vars.bNoScreenEffects ? 0x4e800020 : 0x7D8802A6);
	}

	void ConstantRadar() {
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW2.ConstantRadar), vars.bConstantRadar ? 0x38600001 : 0x481AFE25);
	}

	void Laser() {
		Native::Write4Byte(GetPatch(xbLive.pPatches->MW2.Laser), vars.bLaser ? 0x38600001 : 0x38600000);
	}
	...
	void NoSpread(UserCommand* oldCommand) {
		if (Engine::GetCG()->fAimSpreadScale == 0.f) return;
