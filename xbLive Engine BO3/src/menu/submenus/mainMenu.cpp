...
namespace MainMenuVars {
	...
	void NoRecoil() {
		Native::Write4Byte(0x82227624, vars.bNoRecoil ? 0x60000000 : 0x4BF67EC5); 
	}

	void NoSway() {
		Native::Write4Byte(0x82195200, vars.bNoSway ? 0x60000000 : 0x4BFFEB09); 
	}

	void NoFlinch() {
		Native::Write4Byte(0x821E0824, vars.bNoFlinch ? 0x60000000 : 0x4BFFF77D); 
	}

	void ConstantRadar() {
		Native::Write4Byte(0x821A81A0, vars.bConstantRadar ? 0x60000000 : 0x419A0050); 
	}
